...
public class StdRandom {
    ...
    /*
     * Returns the seed of the psedyrandom number generator
     */
    ...
    public static int uniform(int N) throws IllegalAccessException {
        if (N <= 0)
            throw new IllegalAccessException("Parameter N must be positive");
     ...
     */
    public static int uniform(int a, int b) throws IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    public static void shuffle(Object[] a) throws IllegalAccessException {
        int N = a.length;
        for (int i = 0; i < N; i++) {
     ...
     * @throws IllegalAccessException
     */
    public static void shuffle(double[] a) throws IllegalAccessException {
        int N = a.length;
        for (int i = 0; i < N; i++) {
            int r = i + uniform(N - i);     // between i and N-1
            double temp = a[i];
     ...
     * @throws IllegalAccessException
     */
    public static void shuffle(int[] a) throws IllegalAccessException {
        int N = a.length;
        for (int i = 0; i < N; i++) {
            int r = i + uniform(N - i);     // between i and N-1
            int temp = a[i];
     ...
     * @throws IllegalAccessException
     */
    public static void shuffle(Object[] a, int lo, int hi) throws IllegalAccessException {
     ...
     * @throws IllegalAccessException
     */
    public static void shuffle(double[] a, int lo, int hi) throws IllegalAccessException {
        if (lo < 0 || lo > hi || hi >= a.length) {
            throw new IndexOutOfBoundsException("Illegal subarray range");
        }
        for (int i = lo; i <= hi; i++) {
     ...
     * @throws IllegalAccessException
     */
    public static void shuffle(int[] a, int lo, int hi) throws IllegalAccessException {
        if (lo < 0 || lo > hi || hi >= a.length) {
            throw new IndexOutOfBoundsException("Illegal subarray range");
        }
        for (int i = lo; i <= hi; i++) {
